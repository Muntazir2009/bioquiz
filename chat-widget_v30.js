...
/* ── BOTTOM NAV ── */
#bqnav{
  display:flex;border-top:1px solid var(--bq-glass-border);
...
.bqsnd::after{
  content:'';position:absolute;inset:-3px;border-radius:calc(var(--bq-radius-sm) + 3px);
...
.bqdmr.active-row{background:var(--bq-accent-soft);border-left-color:var(--bq-accent);}
